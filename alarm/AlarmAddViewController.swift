...
class AlarmAddViewController : UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func saveButton(_ sender: Any) {
        alarmSet()
        delegate.AlarmAddViewController(alarmAdd : self, alarmTime : alarmTime)
    ...
    @IBAction func cancelButton(_ sender: Any) {
        delegate.AlarmAddViewController(alarmCancel : self)
        dismiss(animated : true, completion : nil)
    }
    ...
    override func prepare(for segue : UIStoryboardSegue, sender: Any?) {
        ...
        case "showRepeat" :
            guard let nextVC : AlarmRepeatViewController = segue.destination as? AlarmRepeatViewController else {return}
            nextVC.delegate = self
        
            nextVC.selectDay = alarmTime.week
        case "showLabel" :
            guard let nextVC:AlarmAddLabelViewController = segue.destination as? AlarmAddLabelViewController else {return}
            nextVC.delegate = self
...
extension AlarmAddViewController:AlarmRepeatViewControllerDelegate {
...
extension AlarmAddViewController:AlarmAddLabelDelegate {
...
extension AlarmAddViewController:AlarmSnoozeCellDelegte{
    func alarmSnoozeCell(swichOn: AlarmSnoozeCell, On: Bool) {
        alarmTime.snooze = On
    }
}

extension AlarmAddViewController:AlarmDeleteCellDelegate{
